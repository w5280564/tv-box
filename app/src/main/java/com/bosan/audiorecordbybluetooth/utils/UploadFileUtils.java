...
public class UploadFileUtils {
    ...
    public static final String accessKeyId = "LTAI5tFNWYB6mZCjRhzQtuLs";
    public static final String accessKeySecret = "LbdrHDRe01keho5E0hcWvEIaMPjsDv";
    public static final String endpoint ="oss-cn-beijing.aliyuncs.com";
    public static final String bucket = "manglegou";
